    ...
    <header className="bg-white/95 backdrop-blur-md border-b border-slate-200 px-4 py-3 sticky top-0 z-30 shadow-xs">
      <div className="flex items-center justify-between max-w-lg md:max-w-3xl lg:max-w-5xl xl:max-w-6xl mx-auto w-full">
        ...
        <div className="flex items-center gap-2 select-none shrink-0 group">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-600 to-indigo-800 p-0.5 shadow-sm shadow-indigo-200/50 flex items-center justify-center transition-transform group-hover:scale-105">
            <img src="/icon.svg" alt="Trilha do Saber" className="w-full h-full object-contain rounded-[10px]" />
          </div>

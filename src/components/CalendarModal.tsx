        ...
        <div className="p-4 overflow-y-auto space-y-4 flex-1 text-xs">
          ...
          <div className="p-3.5 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-xl overflow-hidden shadow-xs shrink-0 border border-amber-400/80 bg-gradient-to-tr from-amber-600 to-orange-500 p-1 flex items-center justify-center">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-[10px]">
                      <span className="flex items-center gap-1.5 font-bold text-amber-700 bg-amber-50 px-2 py-0.5 rounded-md border border-amber-200">
                        <img src="/icon.svg" alt="App" className="w-3.5 h-3.5 object-contain" />

  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div className="bg-zinc-950 border border-zinc-800 w-full max-w-lg rounded-3xl p-5 sm:p-6 shadow-2xl relative space-y-4 my-auto">
        ...
        <div className="relative rounded-2xl overflow-hidden border border-indigo-500/30 bg-gradient-to-br from-indigo-900/50 via-slate-900 to-zinc-900 shadow-md">
          <div className="aspect-[16/9] w-full relative overflow-hidden flex items-center justify-center bg-slate-950">
            <img
              src={installAppBanner}
              alt="Trilha do Saber - Instalar Aplicativo na Tela Inicial"
